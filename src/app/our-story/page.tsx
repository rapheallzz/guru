      ...
      <div className="py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-stone lg:prose-xl max-w-none text-stone-600">
            <p className="mb-8">
              CraftHaven was born from a desire to celebrate the beauty of the handmade. In an age of mass production and digital noise, we believe there is something profoundly grounding about an object that has been shaped by human hands.
            </p>
