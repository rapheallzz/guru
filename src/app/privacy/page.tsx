  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-20">
      ...
      <div className="prose prose-stone max-w-none text-stone-600">
        <p className="mb-4">At CraftHaven, we value your privacy. As a guest-only shop, we only collect the information necessary to process your orders and provide customer support.</p>
