    ...
    <>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="mt-16">
            <Link href="/custom-requests" className="inline-block px-10 py-4 bg-emerald-700 text-white font-bold rounded-full hover:bg-emerald-800 transition-colors shadow-lg shadow-emerald-700/20">
