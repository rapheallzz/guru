      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
          ...
          <div className="w-full lg:max-w-lg">
            {submitted ? (
              <div className="bg-emerald-800/50 p-6 rounded-lg text-center">
              ...
              <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-4">
                <input
                  ...
                  className="flex-grow px-6 py-4 rounded-md text-stone-900 focus:outline-none focus:ring-2 focus:ring-emerald-500"
                />
                <button
                  type="submit"
                  className="px-8 py-4 bg-white text-emerald-900 font-bold rounded-md hover:bg-stone-100 transition-colors"
                >
                  Sign Up
                </button>
              </form>
